...
(function(){
  ...
  const I18N = {
    ...
    es: {
      ...
      verify_title: 'Verificar certificado', label_serial: 'Ingresa la serie', btn_lookup: 'Buscar', t_sent_email: 'Código enviado al correo', t_email_verified: 'Correo verificado', t_sent_sms: 'SMS enviado', t_phone_verified: 'Teléfono verificado', t_gen_ok: 'Certificado creado', not_found: 'No se encontró el certificado', status_valid: 'Vigente', status_expired: 'Vencido', status_revoked: 'Revocado',
    }
  };
